...
public class EndOfAttackStateMachineBehaviour : StateMachineBehaviour
{
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        //animator?.GetComponent<EnemyController_FOV>()?.StateMachine.ChangeState<IdleState>();
        //animator?.GetComponent<EnemyController_Patrol>()?.StateMachine.ChangeState<IdleState>();
